...
function cws_fgp_shortcode_favourites( $atts ) {
    ...
    // Get ALL photos
    $photos = $flickr->favorites_getList($token['user']['nsid'], $jump_to = NULL, $min_fave_date = NULL, $max_fave_date = NULL, $arrArgs['extras'], $per_page = $num_image_results , $page = $cws_page );
