...
class CWS_Flickr_Gallery_Pro_Admin {
    ...
    public function add_menu_page() {
        ...
        // add_menu_page('Page Title', 'Google Photos', 10, 'cws_fgp', 'section');
        ...
        <?php screen_icon(); ?>
            ...
            <div>
             ...
             ?>
                ...
                <?php 
                // Step 1: The user has not authenticated we give them a link to login    
                if( $flickr->auth_checkToken( $code['api_key'] ) == false ) {
                ?>
                    Not authenticated...
                    </form> 
                    <?php
 ...
 -->                    <h3>Shortcode Usage Examples</h3>
                        ...
                        <div class="metabox-holder">
                            ...
                            <div class="postbox" id="settings">
                                ...
                                <p style="padding:10px;"><strong>Photoset Shortcode Examples</strong></p>
                                ...
                                if( 1 == 1 ) {
                                                ...
                                                <tbody data-wp-lists="list:post" id="the-list">
                                                    ...
                                                    <tr>
                                                        <td class="title column-title">
                                                            <strong><?php echo $album['title']['_content'];?></strong>
                                                        </td>
                                                        ...
                                                        <td class="shortcode column-shortcode">
                                                            <input size="80" type="text" class="shortcode-in-list-table wp-ui-text-highlight code" value="[cws_fgp_photoset id=<?php echo $album['id'];?> theme=grid thumb_size=square_150]" readonly="readonly" onfocus="this.select();">                                     
                                                    </tr>
                                    ...
                                    ?>
                                        ...
                                        <p style="padding:10px;"><strong>Gallery Shortcode Examples</strong></p>
                                        <?php
                                            // Get list of users galleries from Flickr
                                            $photos = $flickr->galleries_getList ($token['user']['nsid'] );
                                        ?>
                                        ...
                                        foreach ( $photos['galleries']['gallery'] as $gallery ) {
                                            ...
                                            ?>
                                                <tbody data-wp-lists="list:post" id="the-list">
                                                    ...
                                                    <tr>
                                                        <td class="title column-title">
                                                            <strong><?php echo $gallery['title']['_content'];?></strong>
                                                        </td>
                                                        ...
                                                        <td class="shortcode column-shortcode">
                                                            <input size="80" type="text" class="shortcode-in-list-table wp-ui-text-highlight code" value="[cws_fgp_galleries id=<?php echo $gid[1];?> theme=grid thumb_size=square_150]" readonly="readonly" onfocus="this.select();">                                     
                                                    </tr>
    ...
    public function options_page() {
        ...
        if( $this->deauthorizeFlickrAccount() ) {
            ...
            delete_option( 'cws_fgp_frob' );
            delete_option( 'cws_fgp_token' );
        } ?>
                ...
                // if not get one form flickr
                    ...
                    if( !get_option( 'cws_fgp_token' ) ) {
                        ...
                        if( empty( $_GET['frob'] ) ) {
                            ...
                            // store it in db
                            update_option( 'cws_fgp_frob', $_GET['frob'] );
                            ...
                            if( $_GET['frob']  ) {
                                ...
                                if ( $r['token'] ) {
                                    update_option( 'cws_fgp_token', $r['token']['_content'] );
                                ...
                                $r = $flickr->auth_getToken( get_option( 'cws_fgp_frob') );

                                if ( $r['token'] ) {
                                    // var_dump($r['token']['_content']);
                                    update_option( 'cws_fgp_token', $r['token']['_content'] );
                                    //$url = admin_url( "options-general.php?page=".$_GET["page"] );                        
                                    //wp_redirect( "$url" );                              
                                }
