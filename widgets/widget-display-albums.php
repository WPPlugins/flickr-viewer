...
class Widget_DisplayAlbums extends WP_Widget {
	...
	function Widget_DisplayAlbums() {		
        parent::__construct( false, $name = 'Flickr Viewer: Small Slideshow' );
	}
    ...
    $flickr = new phpFlickr( $code['api_key'], $code['api_secret'], $plugin_admin->isDev );
...
*/
        ...
        if( $flickr->auth_checkToken( $code['api_key'] ) == true ) {
            ...
            */
            ...
            // Get the posts that have the results shortcode on them [cws_fgp_images_in_album]
